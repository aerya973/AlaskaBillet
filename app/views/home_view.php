        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <p class="card-text mb-auto"><?= $lastArticleLeft['sentence'] ?></a>
            </div>
            <img class="card-img-right flex-auto d-none d-lg-block" src="assets/images/img1.jpg" alt="Card image cap">
          </div>
        </div>
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <a href="#"><?= $lang->home->continue ?></a>
            </div>
            <img class="card-img-right flex-auto d-none d-lg-block" src="assets/images/img2.jpg" alt="Card image cap">
          </div>
        </div>
      </div>
    </div>
    ...
    <main role="main" class="container">
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <?php foreach ($allArticles as $index => $articles): ?>
            <div class="blog-post">
              <h2 class="blog-post-title"><?= $articles['title']?></h2>
              <p class="blog-post-meta"><?= date_format(date_create($articles['date']), "d/m/Y H:i")?> par <a href="#"><?= $articles['firstname'] .' '. $articles['lastname']?></a></p>
